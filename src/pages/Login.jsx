...
function Login() {
  ...
  return (
    <div className='min-h-[calc(100vh-14rem)] w-full flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-green-50/10 to-emerald-50/15 relative py-12 overflow-hidden font-sans'>
      ...
      <div className='w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden grid lg:grid-cols-12 min-h-[580px] border border-gray-100/50 z-10 animate-scale-up'>
          ...
          <div className='space-y-8 relative z-10 my-auto py-10'>
            <div className='space-y-3'>
              <span className='inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-500/20 text-emerald-300 border border-emerald-500/30'>
                <Sparkles className='w-3 h-3' /> Active Citizenship
              </span>
